...
# ad_type -> reportTypeId -> groupBy -> table_name
table_names = {
        "SPONSORED_PRODUCTS": {
            "spCampaigns": {
                "['campaign']": "campaign",
        ...
        "SPONSORED_DISPLAY": {
            "sdCampaigns": {
                "['campaign']": "campaign_v3",
                "['campaign', 'matchedTarget']": "matched_target_v3"
            },
            "sdAdGroup": {
                "['adGroup']": "adgroup_v3",
...
sb_campaign_addtl_metrics = 'campaignBudgetAmount, campaignBudgetCurrencyCode, campaignBudgetType, topOfSearchImpressionShare'
...
metrics = {
    ...
    "SPONSORED_BRANDS": {
        "['campaign']": f'{sb_campaign_base_metrics}',
