...
def request_report(start_date, end_date, marketplace='US', asin_granularity='PARENT'):
    """
...
def download_combine_reports(start_date, end_date, marketplace):
    """
    ...
    while current_date <= end_date:
        try:
            report_id = request_report(current_date, current_date, marketplace)
